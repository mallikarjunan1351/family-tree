    ...
    <div class="vue-family-tree__row">
      ...
      >
        <div class="vue-family-tree__content">
          ...
          >
            <div v-if="block.firstPerson" class="vue-family-tree__person">
              <div class="vue-family-tree__card">
                <slot name="card" :item="block.firstPerson">
                  <Card
                    ...
                    :gender="block.firstPerson.gender"
                    :age="block.firstPerson.age"
                    :relationship="block.firstPerson.relationship"
            ...
            <div v-if="block.secondPerson" class="vue-family-tree__person">
              <div class="vue-family-tree__card">
                <slot name="card" :item="block.secondPerson">
                  <Card
                    :image="block.secondPerson.image"
                    :name="block.secondPerson.name"
                    :gender="block.secondPerson.gender"
                    :age="block.secondPerson.age"
                    :relationship="block.secondPerson.relationship"
